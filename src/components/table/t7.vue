    ...
    data () {
      return {
        data: {
          ...
          claspCourse: true,
          claspCourseMoney: true,
          claspCourseName: true,
          customerName: true,
          employeeName: true,
          facialPractice: true,
          facialPracticeAppoint: true,
          facialPracticeNonSpecifiedt: true,
          highEndProjects: true,
          physicalExercise: true,
          physicalExerciseAppoint: true,
          physicalExerciseNonSpecifiedt: true,
          product: true,
          productCash: true,
          productSnap: true,
          serviceItems: true,
